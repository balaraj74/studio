...
const SchemeSchema = z.object({
  ...
  link: z.string().describe("An official URL for more information, if available."),
});
...
const prompt = ai.definePrompt({
  ...
  Find the most relevant central or state-level schemes. For each scheme, provide its name, a brief description, key eligibility criteria, and a link if you can find one.
